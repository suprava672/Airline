...
public class CommentController {
    ...
    public ResponseEntity<String> deleteComentById(@PathVariable(value = "postId") long postId, @PathVariable(value = "id") long id) {
        commentService.deleteComentById(postId, id);
